 ...
 */
	...
	private function utf8_decodeArray(&$array){
		foreach($array as $param => $value){
			if ( is_array($value) )
				$this->utf8_decodeArray($array[$param]);
			else
				$array[$param] = utf8_decode($array[$param]);
		}	
	}
