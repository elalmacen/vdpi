 ...
 */
	public function read($fields = null, $id = null) {
		...
		if ($id !== null && $id !== false) {
			...
			//$this->utf8_encodeArray($this->data);
 ...
 */
	...
	private function utf8_encodeArray(&$array){
		foreach($array as $param => $value){
			if ( is_array($value) )
				$this->utf8_encodeArray($array[$param]);
			else
				$array[$param] = utf8_encode($array[$param]);
		}	
	}
