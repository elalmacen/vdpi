...
jQuery(function($) {
    ...
    if (jQuery('#livehtml').length > 0) {
        ...
        jQuery('.ws-info').on('mouseover touchstart', function() {
            ...
            jQuery('#livehtml').html('<span class="live wp-exclude-emoji"><span class="tag">&lt;div <span class="ws">⚡</span>&gt</span><span class="text">realtime text for 10.000 viewers, as simple as a HTML attribute</span><span class="tag">&lt;/div&gt</span></span>');
