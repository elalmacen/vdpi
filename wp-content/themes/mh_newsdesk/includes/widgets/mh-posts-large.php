...
class mh_newsdesk_posts_large extends WP_Widget {
    function mh_newsdesk_posts_large() {
        $widget_ops = array('classname' => 'mh_newsdesk_posts_large', 'description' => __('Display posts with large images on front page for use in "Home 1" or "Home 4" widget areas.', 'mh-newsdesk'));
        $this->WP_Widget('mh_newsdesk_posts_large', __('MH Posts Large (Homepage)', 'mh-newsdesk'), $widget_ops);
    }
