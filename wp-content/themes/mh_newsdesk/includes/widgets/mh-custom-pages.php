...
class mh_newsdesk_custom_pages extends WP_Widget {
    function mh_newsdesk_custom_pages() {
        $widget_ops = array('classname' => 'mh_newsdesk_custom_pages', 'description' => __('Custom Pages Widget to display pages based on page IDs.', 'mh-newsdesk'));
        $this->WP_Widget('mh_newsdesk_custom_pages', __('MH Custom Pages', 'mh-newsdesk'), $widget_ops);
    }
